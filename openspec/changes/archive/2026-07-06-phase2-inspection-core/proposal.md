...
- [x] 部署后每小时自动执行巡检（端到端冒烟 @ MySQL 5.7.39 真实触发，17:14:00 Scheduler 触发了 InspectionService）
- [x] 飞书通知卡片内容正确（端到端冒烟 @ 飞书 webhook 56caf1a4-29e3-4552-9a8c-3521be2fdc88 真实送达，17:14:12 飞书群收到「🔔 危废仓库摄像头巡检报告」卡片）
